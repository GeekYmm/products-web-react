      ...
      <div className='container px-6 py-8 mx-auto'>
        <section className='w-full max-w-2xl px-6 py-4 mx-auto bg-white dark:bg-gray-800'>
          ...
          <div className='grid grid-cols-1 gap-6 mt-6 sm:grid-cols-2 md:grid-cols-3'>
            <a href='https://support.qq.com/products/164698' target='view_window' className='flex flex-col items-center px-4 py-3 text-gray-700 transition-colors duration-200 transform rounded-md dark:text-gray-200 hover:bg-blue-200 dark:hover:bg-blue-500'>
              <svg xmlns='http://www.w3.org/2000/svg' className='icon icon-tabler icon-tabler-brand-hipchat' width='30' height='30' viewBox='0 0 24 24' strokeWidth='1.5' stroke='#2c3e50' fill='none' strokeLinecap='round' strokeLinejoin='round'>
            ...
            <a href='https://github.com/yaun369/products-web-react/issues' target='view_window' className='flex flex-col items-center px-4 py-3 text-gray-700 transition-colors duration-200 transform rounded-md dark:text-gray-200 hover:bg-blue-200 dark:hover:bg-blue-500'>
