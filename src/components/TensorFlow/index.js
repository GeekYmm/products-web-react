function TensorFlow() {
  ...
  return (
    <section className='relative bg-white dark:bg-gray-800 p-2'>
      <div className='container px-6 mx-auto'>
        <h1 className='sm:text-2xl text-xl leading-8 sm:leading-9 font-extrabold text-gray-900 capitalize dark:text-white'>微信小程序中使用<span className='text-orange-400'> TensorFlow </span>模型</h1>

        <img className='mt-10 lg:mt-0 lg:col-start-1' src='https://star-1257061493.cos.ap-beijing.myqcloud.com/geekreading/tensorflow-mock-up.png' alt='mockup' />
                ...
                <div key={index} className='p-4 border rounded-xl border-r-gray-200 dark:border-gray-700'>
                  <div className='md:flex md:items-start md:-mx-4'>
                    ...
                    <div className='mt-4 md:mx-4 md:mt-0'>
                      <h1 className='text-xl font-medium text-gray-700 capitalize dark:text-white'>{item.title}</h1>
                      <p className='mt-3 text-base text-gray-500 dark:text-gray-300'>
                        {item.desc}
                        {index === 3 && <a className='text-orange-500 hover:text-orange-400' href='https://github.com/yaun369/tensorflow-wxapp' target='view_window'>github.com/yaun369/tensorflow-wxapp</a>}
                      </p>
                    </div>
                  </div>
                </div>
